...
const result = () => {
    ...
    if (typeof field === 'string') {
        alert(`Zakończyłeś gre: ${field}, liczba rzutów: ${pawnInfo.numberOfThrows}, średnia liczba oczek na rzut: ${Math.round(pawnInfo.numberOfStitches / pawnInfo.numberOfThrows)}`);
        location.reload();
