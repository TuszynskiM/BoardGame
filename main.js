...
const throwCube = () => {
    ...
    dice.style.backgroundPositionX = `${-23 - ((throwedNumber - 1) * 153)}px`
...
const result = () => {
    ...
    if (typeof field === 'string') {
        console.log(`Zakończyłeś gre: ${field}, liczba rzutów: ${pawnInfo.numberOfThrows}, średnia liczba oczek na rzut: ${Math.round(pawnInfo.numberOfStitches / pawnInfo.numberOfThrows)}`);
